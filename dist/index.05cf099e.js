...
const controlRecipes = async function() {
    try {
        ...
        _resultsViewJsDefault.default.update(_modelJs.getSearchSearchResultsPage());
...
const controlSearchResults = async function() {
    try {
        ...
        _resultsViewJsDefault.default.render(_modelJs.getSearchSearchResultsPage());
        _paginationViewDefault.default.render(_modelJs.state.search);
    } catch (err) {
    }
};
const controlPagination = function(goToPage) {
    _resultsViewJsDefault.default.render(_modelJs.getSearchSearchResultsPage(goToPage));
    _paginationViewDefault.default.render(_modelJs.state.search);
};
...
},{"./model.js":"1pVJj","./config":"6V52N","./views/recipeView.js":"82pEw","./views/searchView.js":"jcq1q","./views/resultsView.js":"5peDB","./views/paginationView":"2PAUD","./views/bookmarksView":"764v9","./views/addRecipeView":"Lo2AT","regenerator-runtime/runtime":"1EBPE","core-js/stable":"95FYz","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"1pVJj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
parcelHelpers.export(exports, "getSearchSearchResultsPage", ()=>getSearchSearchResultsPage
);
...
const loadSearchResults = async function(query) {
    try {
        ...
        state.search.page = _config.RES_START_PAGE;
    } catch (err) {
        throw err; //this allows us to throw this error into the controller.js so we can print error message into HTML5
    }
};
const getSearchSearchResultsPage = function(page = state.search.page) {
...
parcelHelpers.export(exports, "RES_START_PAGE", ()=>RES_START_PAGE
);
parcelHelpers.export(exports, "KEY", ()=>KEY
);
parcelHelpers.export(exports, "MODAL_CLOSE_SEC", ()=>MODAL_CLOSE_SEC
);
const API_URL = 'https://forkify-api.herokuapp.com/api/v2/recipes/'; //Good habit to always leave URLs w/ slash at end
const TIMEOUT_SECONDS = 10;
const RES_PER_PAGE = 10;
const RES_START_PAGE = 1;
const KEY = '9b33b106-a048-468c-868c-b0157b7a2879';
...
const timeout = function(s) {
    return new Promise(function(_, reject) {
        setTimeout(function() {
            return reject(new Error(`💥Request took too long! Timeout after ${s} second`));
        }, s * 1000);
    });
};
...
},{"./View":"9dvKv","url:../../img/icons.svg":"5jwFy","../helpers":"9RX9R","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"9dvKv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
   ...
   */ render(data, render = true) {
    ...
    update(data) {
        ...
        newElements.forEach((newEl, i)=>{
            ...
            //Update Changed Text
            if (!newEl.isEqualNode(curEl) && newEl.firstChild?.nodeValue.trim() !== '' //checks to make sure the nodeValue(which we want to be text, is not empty
            ) curEl.textContent = newEl.textContent;
            //Update Changed Attributes
            if (!newEl.isEqualNode(curEl)) //We turn the attributes from newEl into an array AND
...
},{"./View":"9dvKv","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"5peDB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./View.js":"9dvKv","url:../../img/icons.svg":"5jwFy","./previewView":"i65ZK","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"i65ZK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
class PaginationView extends _viewDefault.default {
    ...
    _generateMarkup() {
        ...
        // Last Page
        if (curPage === numPages && numPages > 1) return this._generateBtnPrev(curPage);
        //Other Page
...
class AddRecipeView extends _viewDefault.default {
    _successMessage = 'Upload was successful.';
...
},{"./View":"9dvKv","url:../../img/icons.svg":"5jwFy","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"1EBPE":[function(require,module,exports) {
/**
